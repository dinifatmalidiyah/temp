                ...
                <div class="card-body">
                    <form method="post" action="#" id="myForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="registrasi" class="form-control" id="registrasi" value="" readonly>
                            @error('registrasi')
                        ...
                        <div class="mb-3 row">
                            <div class="col">
                                <label for="nama" class="form-label">Nama Pemohon<span class="text-danger">*</span></label>
                                <input type="text" name="nama" class="form-control" id="nama" placeholder="Masukkan Nama Mesin" value="" readonly>
                                @error('nama_mesin')
                                <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_mesin" class="form-control" id="nama_mesin" placeholder="Masukkan Nama Mesin" value="" required>
                            @error('nama_mesin')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="nama_mesin" class="form-control" id="nama_mesin" placeholder="Masukkan Nama Mesin" value="{{ old('nama_mesin') }}" rows="7" required>{{ old('nama_mesin') }}</textarea>
                            @error('nama_mesin')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
