                            ...
                            <div class="mb-3 row">
                                <div class="col">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="hasil_normal" name="hasil_perbaikan" value="normal" {{ old('hasil_perbaikan') === 'normal' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="hasil_normal">Normal</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" id="hasil_kurang_normal" name="hasil_perbaikan" value="kurang_normal" {{ old('hasil_perbaikan') === 'kurang_normal' ? 'checked' : '' }}>
