...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                @if (auth()->user()->level=='Admin' && $pelaporan->status == 'menunggu')
                    <div class="col-lg-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nm_barang" class="form-control"
                                            value="{{ $pelaporan->datamesin->nama_mesin }}" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kd_barang" class="form-control"
                                            value="{{ $pelaporan->datamesin->kode_jenis }}" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kategori" class="form-control"
                                            value="{{ $pelaporan->datamesin->kategori->nama_kategori }}" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="merk" class="form-control"
                                            value="{{ $pelaporan->datamesin->merk_mesin }}" disabled>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lokasi" class="form-control"
                                            value="{{ $pelaporan->datamesin->workshop->nama_workshop }}" disabled>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" class="form-control" value="{{ $pelaporan->no_registrasi }}"
                                    disabled>
                            </div>
                ...
                <div class="col-lg-4" {{ $pelaporan->status == 'sedang diperbaiki' && auth()->user()->level=='Admin' ? 'hidden' : '' }} {{ $pelaporan->status == 'menunggu' && auth()->user()->level=='Petugas' ? 'hidden' : '' }}>
                    <div class="card card-primary">
                        <div class="card-header">
                            Aksi
                        </div>
