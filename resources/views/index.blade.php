@extends('layout.main')
@section('title'){{'Dashboard - Maintenace'}} @endsection
@section('content')
<!-- Begin Page Content -->
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{$jumlah_petugas}} Petugas</div>
          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <ul>
                ...
                @if ($item->jumlah > 0)
                <li>{{ $item->jumlah }} {{ $item->kategori->nama_kategori }}</li>
                @endif
                @endforeach
              </ul>
            </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Jumlah Klasifikasi</div>
              <ul>
                @foreach ($jumlahKlasifikasi as $item)
                @if ($item->jumlah > 0)
                <li>{{ $item->jumlah }} {{ $item->klasifikasi->nama_klasifikasi }}</li>
                @endif
                @endforeach
              </ul>
            </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
      <div class="card border-left-success shadow h-100 py-2">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Jumlah Mesin</div>
