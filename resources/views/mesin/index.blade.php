...
<div class="container-fluid">
    ...
    <div class="row justify-content-start">
        <div class="col-6">
            ...
            <a href="#" class="btn btn-success btn-icon-split btn-sm mb-3" data-toggle="modal" data-target="#exportModal">
                <span class="icon text-white-50">
                    <i class="fas fa-download"></i>
                </span>
                <span class="text">EXPORT</span>
            </a>
            <button type="button" class="btn btn-success btn btn-danger btn-sm mb-3" data-toggle="modal" data-target="#resetModal">
                Reset
            </button>
