                    ...
                    <form method="post" action="/data-mesin" id="myForm" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="kapasitas" class="form-control" id="kapasitas" placeholder="Masukan Kapasitas Bulanan" value="{{ old('kapasitas') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                @error('kapasitas')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="tahun_mesin" class="form-control" id="tahun_mesin" placeholder="Masukan Tahun" value="{{ old('tahun_mesin') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required>
                                @error('tahun_mesin')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
